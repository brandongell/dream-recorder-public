...
In order to generate dreams, this application uses OpenAI and Google AI's APIs. The approximate costs are as follows (last updated May 2025):

- OpenAI text-to-speech and video prompt generation: < $ 0.01 per dream - [OpenAI Pricing](https://openai.com/api/pricing)
- Google VEO 3 video generation: Currently in preview (check Google AI Studio for pricing) - [Google AI Studio](https://aistudio.google.com/)
...
- Generate an API key for Google AI:
   - Login / sign up to [Google AI Studio](https://aistudio.google.com/) and create an API key
   - Copy the value and paste it to a text file temporarily as you will need it shortly
   - Note: VEO 3 is currently in preview mode (check for any usage limits or costs)
